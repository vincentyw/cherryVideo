...
public class FlintVideoManager {
	...
	public void loadMedia(String url) {
		...
		android.util.Log.d("XXXXXXXXXXX", "url = " + url);
		android.util.Log.d("XXXXXXXXXXX", "metadata = " + metadata);

		mMediaInfo = new MediaInfo.Builder(url)
		...
		mMediaPlayer.load(mApiClient, mMediaInfo, true).setResultCallback(
